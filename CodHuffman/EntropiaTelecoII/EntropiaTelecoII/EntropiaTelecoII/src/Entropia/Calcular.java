...
public class Calcular extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel5.setText("Escriba El Mensaje");
    ...
    private void jButton1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton1ActionPerformed
        ...
        Mensaje = this.jTextField1.getText();//Obtiene el mensaje que ingreso el usuario
...
//            }
            ...
            int saber = 0;//crea variable para saber si ya tomo uno o dos numeros para sumar
                ...
                if (saber == 1) {   //mira si ya encontro los dos numeros menores
                    ...
                    if(temporal22>=temporal2){  // mira si temporal22 es mayor o igual a temporal2
                        ...
                        for(int i=0;i<posi;i++){ //ciclo que va desde 0 hasta posicion
                            if(orden[i]==locacion1){ // mira si orden en la posicion i es igual a lo que guardo locacion0 hara:
                                codigo[i]=codigo[i]+"0"; //a codigo en esa poicion se le asigna un 0
                                orden[i]=locacion1; // orden en la posicion i recibe el valor de locacion0
                            }
                            if(orden[i]==locacion0){ // mira si orden en la posicion i es igual a lo que guardo locacion1 hara:
